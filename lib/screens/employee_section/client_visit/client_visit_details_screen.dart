...
class ClientVisitDetailsScreen extends StatelessWidget {
  static const String route_name = "client_visit_details_screen";

  @override
  Widget build(BuildContext context) {
    ClientVisitInfo clientVisit =
        ModalRoute.of(context)!.settings.arguments as ClientVisitInfo;
                            ...
                            children: [
                              ...
                              _buildField(
                                ...
                                DateFormat(Get.find<AppLocalizationController>()
                                            ...
                                            ? "mm : hh"
                                            : "hh : mm")
                                        .format(clientVisit.startMeetingTime!) +
                                    " " +
                                    (Get.find<AppLocalizationController>()
                                        .getTranslatedValue(
                                            clientVisit.startMeetingTime!.hour >
                                                    12
                                                ? "pm"
                                                : "am")),
                                "clock_outline",
                      ...
                      ? CustomProgressRow(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                Get.find<AppLocalizationController>()
                                    .getTranslatedValue("action_after_visit")
                                    .toUpperCase(),
                                style: Theme.of(context)
                                    .textTheme
                                    .bodyText1!
                              ...
                              _buildField(
                                ...
                                DateFormat(Get.find<AppLocalizationController>()
                                            ...
                                            ? "mm : hh"
                                            : "hh : mm")
                                        .format(clientVisit.endMeetingTime!) +
                                    " " +
                                    (Get.find<AppLocalizationController>()
                                        .getTranslatedValue(
                                            clientVisit.endMeetingTime!.hour >
                                                    12
                                                ? "pm"
                                                : "am")),
                                "clock_outline",
